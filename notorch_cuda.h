// notorch_cuda.h — CUDA/cuBLAS backend for notorch (ported from ariannamethod.ai)
// Zero PyTorch. Zero Python. Pure CUDA C.
//
// Compile: nvcc -c notorch_cuda.cu -lcublas
// Link:    cc ... notorch_cuda.o -lcublas -lcudart -L/usr/local/cuda/lib64
//
// "GPU goes brrrr. No Python required."

#ifndef NOTORCH_CUDA_H
#define NOTORCH_CUDA_H
